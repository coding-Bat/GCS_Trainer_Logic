...
public class Patient {
	...
	public Patient() {
		...
		this.perception = Perception.per[ThreadLocalRandom.current().nextInt(0,4)];
		// Assign a random substring from the corresponding array.
		this.communication = Communication.com[ThreadLocalRandom.current().nextInt(0,5)];
		// Assign a random substring from the corresponding array.
		this.reaction = Reaction.react[ThreadLocalRandom.current().nextInt(0,6)];
